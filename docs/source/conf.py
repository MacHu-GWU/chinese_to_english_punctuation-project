# -*- coding: utf-8 -*-
#
# chinese_to_english_punctuation documentation build configuration file, created by
...
package_name = "chinese_to_english_punctuation"
...
# Add data for Jinja2
try:
    from chinese_to_english_punctuation.docs import doc_data
except:
    doc_data = dict()
